    ...
    public boolean cropBitmap() {
        ...
        if (mSetWallpaper && mNoCrop) {
            ...
            int scaleDownSampleSize =
                    Math.max(1, Math.min(roundedTrueCrop.width() / mOutWidth, roundedTrueCrop.height() / mOutHeight));
            ...
            if (crop == null) {
                ...
                if (fullSize != null) {
                    ...
                    if (roundedTrueCrop.bottom > fullSize.getHeight()) {
                        ...
                        int adjustment =
                                roundedTrueCrop.top - Math.max(0, roundedTrueCrop.bottom - roundedTrueCrop.height());
