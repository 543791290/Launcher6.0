...
/**
 * This class represents a very trivial LauncherExtension. It primarily serves as a simple class to
 * exercise the LauncherOverlay interface.
 */
    ...
    public class LauncherExtensionCallbacks implements LauncherCallbacks {
        ...
        class LauncherExtensionOverlay implements LauncherOverlay {
            ...
            public void setOverlayContainer(InsettableFrameLayout container) {
                mOverlayView = (ViewGroup) getLayoutInflater().inflate(R.layout.launcher_overlay_example, container);
