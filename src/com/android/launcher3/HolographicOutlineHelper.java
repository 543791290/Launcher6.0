...
public class HolographicOutlineHelper {
    ...
    private HolographicOutlineHelper(Context context) {
        ...
        mThinOuterBlurMaskFilter =
                new BlurMaskFilter(res.getDimension(R.dimen.blur_size_thin_outline), BlurMaskFilter.Blur.OUTER);

        mShadowBlurMaskFilter =
                new BlurMaskFilter(res.getDimension(R.dimen.blur_size_click_shadow), BlurMaskFilter.Blur.NORMAL);
