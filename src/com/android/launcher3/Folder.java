...
public class Folder extends LinearLayout
    ...
    /**
     * We avoid measuring {@link #mContentWrapper} with a 0 width or height, as this results in
     * CellLayout being measured as UNSPECIFIED, which it does not support.
     */
    ...
    public void animateOpen() {
        ...
        if (!Utilities.ATLEAST_LOLLIPOP) {
            ...
            Animator reveal =
                    UiThreadCircularReveal.createCircularReveal(this, (int) getPivotX(), (int) getPivotY(), 0, radius);
            ...
            openFolderAnim.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    mFolderName
                            ...
                            .translationX(0)
                            .setInterpolator(
                                    Utilities.ATLEAST_LOLLIPOP ? AnimationUtils.loadInterpolator(mLauncher,
                                            android.R.interpolator.fast_out_slow_in) : new LogDecelerateInterpolator(
                                            100, 0));
    ...
    private int getTargetRank(DragObject d, float[] recycle) {
        ...
        return mContent.findNearestArea((int) recycle[0] - getPaddingLeft(), (int) recycle[1] - getPaddingTop());
    }
    ...
    public void onDropCompleted(final View target, final DragObject d, final boolean isFlingToDelete,
        ...
        if (successfulDrop) {
            ...
            View icon =
                    (mCurrentDragView != null && mCurrentDragView.getTag() == info) ? mCurrentDragView : mContent
                            .createNewView(info);
    ...
    private int getContentAreaHeight() {
        ...
        int maxContentAreaHeight =
                grid.availableHeightPx - workspacePadding.top - workspacePadding.bottom - mFooterHeight;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mContent.getChildCount() > 0) {
            int cellIconGap = (mContent.getPageAt(0).getCellWidth() - mLauncher.getDeviceProfile().iconSizePx) / 2;
            mFooter.setPadding(mContent.getPaddingLeft() + cellIconGap, mFooter.getPaddingTop(),
