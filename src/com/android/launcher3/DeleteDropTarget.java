...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    public static boolean supportsDrop(Object info) {
        return (info instanceof ShortcutInfo) || (info instanceof LauncherAppWidgetInfo)
    ...
    public void onFlingToDelete(final DragObject d, PointF vel) {
        ...
        FlingAnimation fling =
                new FlingAnimation(d, vel, getIconRect(d.dragView.getMeasuredWidth(), d.dragView.getMeasuredHeight(),
                        mDrawable.getIntrinsicWidth(), mDrawable.getIntrinsicHeight()), dragLayer);
