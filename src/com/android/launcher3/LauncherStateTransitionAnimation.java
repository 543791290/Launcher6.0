 ...
 *
 * Things to test when changing the following class. - Home from workspace - from center screen -
...
public class LauncherStateTransitionAnimation {
     ...
     *        Apps is completed.
     */
    public void startAnimationToAllApps(final Workspace.State fromWorkspaceState, final boolean animated,
        ...
        PrivateTransitionCallbacks cb = new PrivateTransitionCallbacks() {
            ...
            @Override
            public AnimatorListenerAdapter getMaterialRevealViewAnimatorListener(final View revealView,
        ...
        mCurrentAnimation =
                startAnimationToOverlay(fromWorkspaceState, Workspace.State.NORMAL_HIDDEN, buttonView, toView,
                        toView.getContentView(), toView.getRevealView(), toView.getSearchBarView(), animated, cb);
    }

    /**
     * Starts an animation to the widgets view.
     */
    public void startAnimationToWidgets(final Workspace.State fromWorkspaceState, final boolean animated) {
        ...
        mCurrentAnimation =
                startAnimationToOverlay(fromWorkspaceState, Workspace.State.OVERVIEW_HIDDEN, buttonView, toView,
                        toView.getContentView(), toView.getRevealView(), null, animated, cb);
    }

    /**
     * Starts and animation to the workspace from the current overlay view.
     */
    public void startAnimationToWorkspace(final Launcher.State fromState, final Workspace.State fromWorkspaceState,
            final Workspace.State toWorkspaceState, final int toWorkspacePage, final boolean animated,
            final Runnable onCompleteRunnable) {
        if (toWorkspaceState != Workspace.State.NORMAL && toWorkspaceState != Workspace.State.SPRING_LOADED
        ...
        if (fromState == Launcher.State.APPS || fromState == Launcher.State.APPS_SPRING_LOADED) {
            ...
            startAnimationToWorkspaceFromWidgets(fromWorkspaceState, toWorkspaceState, toWorkspacePage, animated,
                    onCompleteRunnable);
        }
    }
    ...
    private AnimatorSet startAnimationToOverlay(final Workspace.State fromWorkspaceState,
            final Workspace.State toWorkspaceState, final View buttonView, final View toView, final View contentView,
        ...
        Animator workspaceAnim =
                mLauncher.startWorkspaceStateChangeAnimation(toWorkspaceState, -1, animated, layerViews);
    ...
    private void startAnimationToWorkspaceFromAllApps(final Workspace.State fromWorkspaceState,
        ...
        mCurrentAnimation =
                startAnimationToWorkspaceFromOverlay(fromWorkspaceState, toWorkspaceState, toWorkspacePage,
                        mLauncher.getAllAppsButton(), appsView, appsView.getContentView(), appsView.getRevealView(),
    ...
    private AnimatorSet startAnimationToWorkspaceFromOverlay(final Workspace.State fromWorkspaceState,
            ...
            final View fromView, final View contentView, final View revealView, final View overlaySearchBarView,
            final boolean animated, final Runnable onCompleteRunnable, final PrivateTransitionCallbacks pCb) {
        final AnimatorSet animation = LauncherAnimUtils.createAnimatorSet();
        final Resources res = mLauncher.getResources();
        final boolean material = Utilities.ATLEAST_LOLLIPOP;
        final int revealDuration = res.getInteger(R.integer.config_overlayRevealTime);
        ...
        // NOTE: this call apparently also sets the state for the workspace if !animated
        Animator workspaceAnim =
                mLauncher.startWorkspaceStateChangeAnimation(toWorkspaceState, toWorkspacePage, animated, layerViews);
        ...
        if (animated && initialized) {
            ...
            if (fromView.getVisibility() == View.VISIBLE) {
                ...
                TimeInterpolator decelerateInterpolator =
                        material ? new LogDecelerateInterpolator(100, 0) : new DecelerateInterpolator(1f);
                ...
                if (material) {
                    ...
                    Animator reveal =
                            UiThreadCircularReveal.createCircularReveal(revealView, width / 2, height / 2,
     ...
     */
    private void startWorkspaceSearchBarAnimation(AnimatorSet animation, final Workspace.State fromWorkspaceState,
            final Workspace.State toWorkspaceState, int duration, View overlaySearchBar) {
    ...
    void dispatchOnLauncherTransitionStart(View v, boolean animated, boolean toWorkspace) {
        if (v instanceof LauncherTransitionable) {
            ((LauncherTransitionable) v).onLauncherTransitionStart(mLauncher, animated, toWorkspace);
        }
    ...
    void dispatchOnLauncherTransitionEnd(View v, boolean animated, boolean toWorkspace) {
        if (v instanceof LauncherTransitionable) {
            ((LauncherTransitionable) v).onLauncherTransitionEnd(mLauncher, animated, toWorkspace);
        }
