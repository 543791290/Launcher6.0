...
public class SettingsActivity extends Activity {
    ...
    public static class LauncherSettingsFragment extends PreferenceFragment implements OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Bundle value =
                    getActivity().getContentResolver().call(LauncherSettings.Settings.CONTENT_URI,
                            LauncherSettings.Settings.METHOD_GET_BOOLEAN, Utilities.ALLOW_ROTATION_PREFERENCE_KEY,
                            extras);
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            getActivity().getContentResolver().call(LauncherSettings.Settings.CONTENT_URI,
                    LauncherSettings.Settings.METHOD_SET_BOOLEAN, preference.getKey(), extras);
            return true;
        }
    }
}
