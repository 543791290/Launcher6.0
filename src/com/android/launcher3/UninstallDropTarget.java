...
public class UninstallDropTarget extends ButtonDropTarget {
    ...
    /**
     * @return the component name and flags if
     * @param info is an AppInfo or an app shortcut.
     */
    ...
    public static boolean startUninstallActivity(Launcher launcher, Object info) {
        ...
        return launcher.startApplicationUninstallActivity(componentInfo.first, componentInfo.second, user);
    }
    ...
    public static interface UninstallSource {
        ...
        /**
         * Indicates that an uninstall request are made and the actual result may come after some
         * time.
         */
