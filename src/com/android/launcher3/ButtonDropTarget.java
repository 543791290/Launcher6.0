...
public abstract class ButtonDropTarget extends TextView
    ...
    private void animateTextColor(int targetColor) {
        ...
        ValueAnimator anim1 =
                ValueAnimator.ofObject(new FloatArrayEvaluator(mCurrentFilter.getArray()), mSrcFilter.getArray(),
                        mDstFilter.getArray());
    ...
    public void onDrop(final DragObject d) {
        ...
        dragLayer.animateView(d.dragView, from, to, scale, 1f, 1f, 0.1f, 0.1f, DRAG_VIEW_DROP_DURATION,
