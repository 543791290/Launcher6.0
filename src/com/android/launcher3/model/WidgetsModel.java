        ...
        for (Object o : rawWidgetsShortcuts) {
            ...
            if (o instanceof LauncherAppWidgetProviderInfo) {
                ...
                if (minSpanX <= (int) idp.numColumns && minSpanY <= (int) idp.numRows) {
                    ...
                    if (DEBUG) {
                        Log.d(TAG, String.format("Widget %s : (%d X %d) can't fit on this device", widgetInfo.provider,
                                minSpanX, minSpanY));
                    }
                    continue;
                }
            ...
            if (widgetsShortcutsList != null) {
                ...
                mIconCache.getTitleAndIconForApp(packageName, userHandle, true /* userLowResIcon */, pInfo);
