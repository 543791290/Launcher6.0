...
/**
 * Fallback class to support Alphabetic indexing if not supported by the framework. TODO(winsonc):
 * disable for non-english locales
 */
...
public class AlphabeticIndexCompat extends BaseAlphabeticIndex {
    ...
    public AlphabeticIndexCompat(Context context) {
        ...
        try {
            ...
            if (curLocale.getLanguage().equals(Locale.JAPANESE.getLanguage())) {
                ...
                mDefaultMiscLabel = "\u4ed6";
                // TODO(winsonc, omakoto): We need to handle Japanese sections better, especially
                // the kanji
            } else {
                // Dot
    ...
    /**
     * Computes the section name for an given string
     * 
     * @param s .
     */
    ...
    /**
     * Returns the index of the bucket in which
     * 
     * @param s should appear. Function is synchronized because underlying routine walks an iterator
