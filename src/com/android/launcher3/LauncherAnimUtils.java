...
public class LauncherAnimUtils {
    ...
    public static ValueAnimator createCircularReveal(View view, int centerX, int centerY, float startRadius,
            float endRadius) {
        ValueAnimator anim =
                UiThreadCircularReveal.createCircularReveal(view, centerX, centerY, startRadius, endRadius);
        new FirstFrameAnimatorHelper(anim, view);
        return anim;
    }
}
