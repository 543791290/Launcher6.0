...
public class LauncherProvider extends ContentProvider {
    ...
    @Thunk
    static long dbInsertAndCheck(DatabaseHelper helper, SQLiteDatabase db, String table, String nullColumnHack,
        ...
        switch (method) {
            case LauncherSettings.Settings.METHOD_GET_BOOLEAN: {
                ...
                result.putBoolean(
                        ...
                        getContext().getSharedPreferences(LauncherAppState.getSharedPreferencesKey(),
                                Context.MODE_PRIVATE).getBoolean(arg,
                                extras.getBoolean(LauncherSettings.Settings.EXTRA_DEFAULT_VALUE)));
                return result;
            }
            case LauncherSettings.Settings.METHOD_SET_BOOLEAN: {
                boolean value = extras.getBoolean(LauncherSettings.Settings.EXTRA_VALUE);
                getContext().getSharedPreferences(LauncherAppState.getSharedPreferencesKey(), Context.MODE_PRIVATE)
    ...
    public List<Long> deleteEmptyFolders() {
        ...
        try {
            ...
            String selection =
                    LauncherSettings.Favorites.ITEM_TYPE + " = " + LauncherSettings.Favorites.ITEM_TYPE_FOLDER
                            + " AND " + LauncherSettings.Favorites._ID + " NOT IN (SELECT "
                            + LauncherSettings.Favorites.CONTAINER + " FROM " + TABLE_FAVORITES + ")";
            Cursor c =
                    db.query(TABLE_FAVORITES, new String[] {LauncherSettings.Favorites._ID}, selection, null, null,
                            null, null);
            while (c.moveToNext()) {
            ...
            c.close();
            if (folderIds.size() > 0) {
                db.delete(TABLE_FAVORITES, Utilities.createDbSelectionQuery(LauncherSettings.Favorites._ID, folderIds),
                        null);
            }
            db.setTransactionSuccessful();
    ...
    public void clearFlagEmptyDbCreated() {
        ...
        getContext().getSharedPreferences(spKey, Context.MODE_PRIVATE).edit().remove(EMPTY_DATABASE_CREATED).commit();
    }
        ...
        if (sp.getBoolean(EMPTY_DATABASE_CREATED, false)) {
            ...
            if (loader == null) {
                ...
                if (partner != null && partner.hasDefaultLayout()) {
                    ...
                    if (workspaceResId != 0) {
                        loader =
                                new DefaultLayoutParser(getContext(), mOpenHelper.mAppWidgetHost, mOpenHelper,
    ...
    private AutoInstallsLayout createWorkspaceLoaderFromAppRestriction() {
        ...
        if (packageName != null) {
            try {
                ...
                return AutoInstallsLayout.get(ctx, packageName, targetResources, mOpenHelper.mAppWidgetHost,
                        mOpenHelper);
    ...
    private DefaultLayoutParser getDefaultLayoutParser() {
        ...
        return new DefaultLayoutParser(getContext(), mOpenHelper.mAppWidgetHost, mOpenHelper, getContext()
                .getResources(), defaultLayout);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE favorites (" + "_id INTEGER PRIMARY KEY," + "title TEXT," + "intent TEXT,"
                    ...
                    + "profileId INTEGER DEFAULT " + userSerialNumber + "," + "rank INTEGER NOT NULL DEFAULT 0,"
            ...
            if (mAppWidgetHost != null) {
                ...
                /**
                 * Send notification that we've deleted the {@link AppWidgetHost}, probably as part
                 * of the initial database creation. The receiver may want to re-call
        ...
        private void addWorkspacesTable(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + TABLE_WORKSPACE_SCREENS + " (" + LauncherSettings.WorkspaceScreens._ID
                    + " INTEGER PRIMARY KEY," + LauncherSettings.WorkspaceScreens.SCREEN_RANK + " INTEGER,"
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // version of the DB.
                ...
                case 18: {
                    ...
                    // user
                    // will never see these items anyway, we use database upgrade as an opportunity
                    // to
                    // clean things up.
        ...
        void convertShortcutsToLauncherActivities(SQLiteDatabase db) {
            ...
            try {
                ...
                c =
                        db.query(TABLE_FAVORITES, new String[] {Favorites._ID, Favorites.INTENT,}, "itemType="
                                + Favorites.ITEM_TYPE_SHORTCUT + " AND profileId=" + userSerial, null, null, null, null);

                updateStmt =
                        db.compileStatement("UPDATE favorites SET itemType=" + Favorites.ITEM_TYPE_APPLICATION
                                + " WHERE _id=?");
        ...
        public boolean recreateWorkspaceTable(SQLiteDatabase db) {
            ...
            try {
                Cursor c =
                        db.query(TABLE_WORKSPACE_SCREENS, new String[] {LauncherSettings.WorkspaceScreens._ID}, null,
                                null, null, null, LauncherSettings.WorkspaceScreens.SCREEN_RANK);
        ...
        boolean updateFolderItemsRank(SQLiteDatabase db, boolean addRankColumn) {
            ...
            try {
                ...
                Cursor c =
                        db.rawQuery("SELECT container, MAX(cellX) FROM favorites"
                ...
                while (c.moveToNext()) {
                    db.execSQL("UPDATE favorites SET rank=cellX+(cellY*?) WHERE "
                            + "container=? AND cellX IS NOT NULL AND cellY IS NOT NULL;", new Object[] {
                            c.getLong(1) + 1, c.getLong(0)});
                }
        ...
        private boolean addIntegerColumn(SQLiteDatabase db, String columnName, long defaultValue) {
            db.beginTransaction();
            try {
                db.execSQL("ALTER TABLE favorites ADD COLUMN " + columnName + " INTEGER NOT NULL DEFAULT "
                        + defaultValue + ";");
                db.setTransactionSuccessful();
            } catch (SQLException ex) {
                Log.e(TAG, ex.getMessage(), ex);
