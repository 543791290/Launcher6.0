...
public class ManagedProfileHeuristic {
    ...
    private void markForAddition(LauncherActivityInfoCompat info, long installTime) {
        ArrayList<ShortcutInfo> targetList =
                (installTime <= mUserCreationTime + AUTO_ADD_TO_FOLDER_DURATION) ? mWorkFolderApps : mHomescreenApps;
    ...
    /**
     * Verifies that entries corresponding to
     * 
     * @param users exist and removes all invalid entries.
     */
    public static void processAllUsers(List<UserHandleCompat> users, Context context) {
        ...
        SharedPreferences prefs =
                context.getSharedPreferences(LauncherFiles.MANAGED_USER_PREFERENCES_KEY, Context.MODE_PRIVATE);
