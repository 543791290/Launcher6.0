...
/**
 * This class differs from the framework {@link android.widget.EdgeEffect}: 1) It does not use
 * PorterDuffXfermode 2) The width to radius factor is smaller (0.5 instead of 0.75)
 */
public class LauncherEdgeEffect {
    ...
    /**
     * A view should call this when content is pulled away from an edge by the user. This will
     * update the state of the current visual effect and its associated animation. The host view
     * should always {@link android.view.View#invalidate()} after this and draw the results
     * accordingly.
     *
     * <p>
     * Views using EdgeEffect should favor {@link #onPull(float, float)} when the displacement of
     * the pull point is known.
     * </p>
     *
     * @param deltaDistance Change in distance since the last call. Values may be 0 (no change) to
     *        1.f (full length of the view) or negative values to express change back toward the
     *        edge reached to initiate the effect.
     */
     ...
     *        initiating the pull. In the case of touch this is the finger position. Values may be
     *        from 0-1.
     */
    public void onPull(float deltaDistance, float displacement) {
        ...
        if (mPullDistance == 0) {
            ...
            final float scale =
                    (float) (Math.max(0, 1 - 1 / Math.sqrt(Math.abs(mPullDistance) * mBounds.height()) - 0.3d) / 0.7d);
     ...
     *
     * <p>
     * When using a {@link android.widget.Scroller} or {@link android.widget.OverScroller}, the
