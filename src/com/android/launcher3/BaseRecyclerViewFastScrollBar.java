...
public class BaseRecyclerViewFastScrollBar {
    ...
    public BaseRecyclerViewFastScrollBar(BaseRecyclerView rv, Resources res) {
        ...
        mThumbInactiveColor =
                rv.getFastScrollerThumbInactiveColor(res.getColor(R.color.container_fastscroll_thumb_inactive_color));
    ...
    public void setThumbOffset(int x, int y) {
        ...
        updateThumbPath();
        mInvalidateRect.union(mThumbOffset.x - mThumbCurvature, mThumbOffset.y, mThumbOffset.x + mThumbWidth,
                mThumbOffset.y + mThumbHeight);
    ...
    public void setTrackWidth(int width) {
        mInvalidateRect.set(mThumbOffset.x - mThumbCurvature, 0, mThumbOffset.x + mThumbWidth, mRv.getHeight());
        mTrackWidth = width;
        updateThumbPath();
        mInvalidateRect.union(mThumbOffset.x - mThumbCurvature, 0, mThumbOffset.x + mThumbWidth, mRv.getHeight());
        mRv.invalidate(mInvalidateRect);
    }
    ...
    private void animateScrollbar(boolean isScrolling) {
        ...
        ObjectAnimator trackWidthAnim =
                ObjectAnimator.ofInt(this, "trackWidth", isScrolling ? mThumbMaxWidth : mThumbMinWidth);
        ObjectAnimator thumbWidthAnim =
                ObjectAnimator.ofInt(this, "thumbWidth", isScrolling ? mThumbMaxWidth : mThumbMinWidth);
        mScrollbarAnimator.playTogether(trackWidthAnim, thumbWidthAnim);
        if (mThumbActiveColor != mThumbInactiveColor) {
            ValueAnimator colorAnimation =
                    ValueAnimator.ofObject(new ArgbEvaluator(), mThumbPaint.getColor(), isScrolling
                            ? mThumbActiveColor
                            : mThumbInactiveColor);
            colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animator) {
                    ...
                    mRv.invalidate(mThumbOffset.x, mThumbOffset.y, mThumbOffset.x + mThumbWidth, mThumbOffset.y
                            + mThumbHeight);
                }
            });
    ...
    private void updateThumbPath() {
        ...
        mThumbPath.cubicTo(mThumbOffset.x, mThumbOffset.y + mThumbHeight, mThumbOffset.x - mThumbCurvature,
                mThumbOffset.y + mThumbHeight / 2, mThumbOffset.x, mThumbOffset.y); // bl2tl
        mThumbPath.close();
    }
