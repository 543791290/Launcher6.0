...
public class ShortcutInfo extends ItemInfo {
    ...
    /**
     * Indicates if it represents a common type mentioned in {@link CommonAppTypeParser}. Upto 15
     ...
     * Bitmap (if true.) TODO: remove this flag
     */
    ...
    public static ShortcutInfo fromActivityInfo(LauncherActivityInfoCompat info, Context context) {
        ...
        shortcut.contentDescription =
                UserManagerCompat.getInstance(context).getBadgedLabelForUser(info.getLabel(), info.getUser());
