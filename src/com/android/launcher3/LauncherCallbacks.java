...
/**
 * LauncherCallbacks is an interface used to extend the Launcher activity. It includes many hooks in
 * order to add additional functionality. Some of these are very general, and give extending classes
 * the ability to react to Activity life-cycle or specific user interactions. Others are more
 * specific and relate to replacing parts of the application, for example, the search interface or
 * the wallpaper picker.
 */
public interface LauncherCallbacks {

    /*
     * Activity life-cycle methods. These methods are triggered after the code in the corresponding
     * Launcher method is executed.
     */
    ...
    /**
     * Returning true will immediately result in a call to
     * {@link #setLauncherOverlayView(ViewGroup, com.android.launcher3.Launcher.LauncherOverlayCallbacks)}
     * .
     *
