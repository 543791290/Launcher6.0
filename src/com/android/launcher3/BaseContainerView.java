...
public abstract class BaseContainerView extends LinearLayout implements Insettable {
    ...
    protected void updateBackgroundAndPaddings() {
        ...
        if (!isValidSearchBarBounds(mFixedSearchBarBounds)) {
            ...
            padding =
                    new Rect(mInsets.left + mContainerBoundsInset, (mHasSearchBar
                            ? 0
                            : (mInsets.top + mContainerBoundsInset)), mInsets.right + mContainerBoundsInset,
            ...
            searchBarBounds.set(mInsets.left + mContainerBoundsInset, mInsets.top + mContainerBoundsInset,
            ...
            padding =
                    new Rect(mFixedSearchBarBounds.left, (mHasSearchBar ? 0 : (mInsets.top + mContainerBoundsInset)),
                            getMeasuredWidth() - mFixedSearchBarBounds.right, mInsets.bottom + mContainerBoundsInset);
        ...
        if (!padding.equals(mContentPadding) || !searchBarBounds.equals(mSearchBarBounds)) {
            ...
            mContentBounds.set(padding.left, padding.top, getMeasuredWidth() - padding.right, getMeasuredHeight()
                    - padding.bottom);
    ...
    private boolean isValidSearchBarBounds(Rect searchBarBounds) {
        return !searchBarBounds.isEmpty() && searchBarBounds.right <= getMeasuredWidth()
