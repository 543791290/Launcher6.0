...
public class CellLayout extends ViewGroup implements BubbleTextShadowHandler {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mTouchFeedbackView.measure(
                MeasureSpec.makeMeasureSpec(mCellWidth + mTouchFeedbackView.getExtraSize(), MeasureSpec.EXACTLY),
                MeasureSpec.makeMeasureSpec(mCellHeight + mTouchFeedbackView.getExtraSize(), MeasureSpec.EXACTLY));

        mShortcutsAndWidgets.measure(MeasureSpec.makeMeasureSpec(newWidth, MeasureSpec.EXACTLY),
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mTouchFeedbackView.layout(left, top, left + mTouchFeedbackView.getMeasuredWidth(),
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mBackground.setBounds(-mTempRect.left, -mTempRect.top, w + mTempRect.right, h + mTempRect.bottom);
    }
    ...
    private ItemConfiguration findReorderSolution(int pixelX, int pixelY, int minSpanX, int minSpanY, int spanX,
    ...
    private ItemConfiguration findConfigurationNoShuffle(int pixelX, int pixelY, int minSpanX, int minSpanY, int spanX,
