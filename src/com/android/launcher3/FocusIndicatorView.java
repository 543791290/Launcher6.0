...
public class FocusIndicatorView extends View implements View.OnFocusChangeListener {
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (hasFocus) {
            ...
            if (mLastFocusedView == v) {
                ...
                endCurrentAnimation();
                mCurrentAnimation =
                        LauncherAnimUtils.ofPropertyValuesHolder(this, PropertyValuesHolder.ofFloat(View.ALPHA, 0));
            }
        }
    ...
    /**
     * Computes the location of a view relative to
     * 
     * @param parent , off-setting any shift due to page view scroll.
