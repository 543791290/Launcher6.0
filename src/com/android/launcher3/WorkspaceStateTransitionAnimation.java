...
public class WorkspaceStateTransitionAnimation {
    ...
    public AnimatorSet getAnimationToState(Workspace.State fromState, Workspace.State toState, int toPage,
    ...
    private void animateWorkspace(final TransitionStates states, int toPage, final boolean animated,
            final int duration, final HashMap<View, Integer> layerViews, final boolean accessibilityEnabled) {
        ...
        float finalWorkspaceTranslationY =
                states.stateIsOverview || states.stateIsOverviewHidden ? mWorkspace.getOverviewModeTranslationY() : 0;
        ...
        if (animated) {
                ...
                if (mOldAlphas[i] == 0 && mNewAlphas[i] == 0) {
                    ...
                    if (mOldBackgroundAlphas[i] != 0 || mNewBackgroundAlphas[i] != 0) {
                        ValueAnimator bgAnim =
                                ObjectAnimator.ofFloat(cl, "backgroundAlpha", mOldBackgroundAlphas[i],
            ...
            LauncherViewPropertyAnimator hotseatAlpha =
                    new LauncherViewPropertyAnimator(hotseat).alpha(finalHotseatAndPageIndicatorAlpha);
