...
public class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDeviceProfile =
                getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? app
                        .getInvariantDeviceProfile().landscapeProfile : app.getInvariantDeviceProfile().portraitProfile;
        ...
        if (mLauncherCallbacks != null) {
            ...
            if (mLauncherCallbacks.hasLauncherOverlay()) {
                ...
                mLauncherOverlay =
                        mLauncherCallbacks.setLauncherOverlayView(mLauncherOverlayContainer, mLauncherOverlayCallbacks);
    ...
    protected void onResume() {
        ...
        if (mOnResumeState == State.WORKSPACE) {
            ...
            showAppsView(false /* animated */, false /* resetListToTop */, !launchedFromApp /* updatePredictedApps */,
     ...
     */
    @Thunk
    void completeAddAppWidget(int appWidgetId, long container, long screenId, AppWidgetHostView hostView,
            LauncherAppWidgetProviderInfo appWidgetInfo) {

        ItemInfo info = mPendingAddInfo;
        if (appWidgetInfo == null) {
            appWidgetInfo =
                    LauncherAppWidgetProviderInfo.fromProviderInfo(this,
        ...
        if (!mRestoring) {
            ...
            mWorkspace.addInScreen(launcherInfo.hostView, container, screenId, info.cellX, info.cellY,
    ...
    /**
     * Sets up transparent navigation and status bars in Lollipop. This method is a no-op for other
     * platform versions.
     */
    ...
    protected void onNewIntent(Intent intent) {
        ...
        // animation.
        if (isActionMain) {
            boolean moveToDefaultScreen =
                    mLauncherCallbacks != null ? mLauncherCallbacks.shouldMoveToDefaultScreenOnHomeIntent() : true;
    ...
    void addAppWidgetImpl(final int appWidgetId, final ItemInfo info, final AppWidgetHostView boundWidget,
            final LauncherAppWidgetProviderInfo appWidgetInfo, int delay) {
    ...
    protected void onClickAllAppsButton(View v) {
        ...
        if (!isAppsViewVisible()) {
            showAppsView(true /* animated */, false /* resetListToTop */, true /* updatePredictedApps */, false /* focusSearchBar */);
    ...
    private void showBrokenAppInstallDialog(final String packageName,
        ...
        new AlertDialog.Builder(this).setTitle(R.string.abandoned_promises_title)
    ...
    void showWorkspace(int snapToPage, boolean animated, Runnable onCompleteRunnable) {
        ...
        if (changed) {
            ...
            mStateTransitionAnimation.startAnimationToWorkspace(mState, mWorkspace.getState(), Workspace.State.NORMAL,
    ...
    void showOverviewMode(boolean animated) {
        mWorkspace.setVisibility(View.VISIBLE);
        mStateTransitionAnimation.startAnimationToWorkspace(mState, mWorkspace.getState(), Workspace.State.OVERVIEW,
                WorkspaceStateTransitionAnimation.SCROLL_TO_CURRENT_PAGE, animated, null /* onCompleteRunnable */);
        mState = State.WORKSPACE;
    }
     ...
     * new state.
     */
    public Animator startWorkspaceStateChangeAnimation(Workspace.State toState, int toPage, boolean animated,
    ...
    public void enterSpringLoadedDragMode() {
        ...
        mStateTransitionAnimation.startAnimationToWorkspace(mState, mWorkspace.getState(),
                Workspace.State.SPRING_LOADED, WorkspaceStateTransitionAnimation.SCROLL_TO_CURRENT_PAGE,
    ...
    void exitSpringLoadedDragMode() {
        if (mState == State.APPS_SPRING_LOADED) {
            showAppsView(true /* animated */, false /* resetListToTop */, false /* updatePredictedApps */, false /* focusSearchBar */);
     ...
     * onResume.
     *
     * This needs to be called from incoming places where resources might have been loaded while the
     * activity is paused. That is because the Configuration (e.g., rotation) might be wrong when
    ...
    private boolean canRunNewAppsAnimation() {
        ...
        return diff > (NEW_APPS_ANIMATION_INACTIVE_TIMEOUT_SECONDS * 1000) && (mClings == null || !mClings.isVisible());
    }
    ...
    void showWorkspaceSearchAndHotseat() {
        ...
        if (mSearchDropTargetBar != null) mSearchDropTargetBar.animateToState(SearchDropTargetBar.State.SEARCH_BAR, 0);
    }
    ...
    void hideWorkspaceSearchAndHotseat() {
        ...
        if (mSearchDropTargetBar != null) mSearchDropTargetBar.animateToState(SearchDropTargetBar.State.INVISIBLE, 0);
    }
