 ...
 *
 * <p>
 * Memory vs. Performance: The less number of types of views are inserted into a
 * {@link RecyclerView}, the more recycling happens and less memory is consumed.
 * {@link #getItemViewType} was not overridden as there is only a single type of view.
 */
public class WidgetsListAdapter extends Adapter<WidgetsRowViewHolder> {
    ...
    public WidgetsListAdapter(Context context, View.OnClickListener iconClickListener,
            View.OnLongClickListener iconLongClickListener, Launcher launcher) {
    ...
    public void onBindViewHolder(WidgetsRowViewHolder holder, int pos) {
        ...
        if (DEBUG) {
            Log.d(TAG, String.format("onBindViewHolder [pos=%d, widget#=%d, row.getChildCount=%d]", pos,
