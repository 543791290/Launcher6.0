...
public class WidgetsContainerView extends BaseContainerView
    ...
    public void onClick(View v) {
        ...
        if (!mLauncher.isWidgetsViewVisible() || mLauncher.getWorkspace().isSwitchingState()
    ...
    private boolean beginDraggingWidget(WidgetCell v) {
        ...
        if (createItemInfo instanceof PendingAddWidgetInfo) {
            ...
            preview =
                    getWidgetPreviewLoader().generateWidgetPreview(mLauncher, createWidgetInfo.info, maxWidth, null,
    ...
    protected void onUpdateBackgroundAndPaddings(Rect searchBarBounds, Rect padding) {
        ...
        InsetDrawable background =
                new InsetDrawable(getResources().getDrawable(R.drawable.quantum_panel_shape_dark), padding.left, 0,
                        padding.right, 0);
