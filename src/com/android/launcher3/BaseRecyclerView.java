...
public abstract class BaseRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    /**
     * The current scroll state of the recycler view. We use this in onUpdateScrollbar() and
     * scrollToPositionAtProgress() to determine the scroll position of the recycler view so that we
     * can calculate what the scroll bar looks like, and where to jump to from the fast scroller.
     */
    ...
    /**
     * Returns the available scroll bar height: AvailableScrollBarHeight = Total height of the
     * visible view - thumb height
     */
