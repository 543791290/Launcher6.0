...
public class Workspace extends PagedView
    ...
    enum State {
        NORMAL(SearchDropTargetBar.State.SEARCH_BAR), NORMAL_HIDDEN(SearchDropTargetBar.State.INVISIBLE), SPRING_LOADED(
                SearchDropTargetBar.State.DROP_TARGET), OVERVIEW(SearchDropTargetBar.State.INVISIBLE), OVERVIEW_HIDDEN(
    ...
    public long insertNewWorkspaceScreen(long screenId, int insertIndex) {
        ...
        CellLayout newScreen =
                (CellLayout) mLauncher.getLayoutInflater()
    ...
    public void createCustomContentContainer() {
        CellLayout customScreen =
                (CellLayout) mLauncher.getLayoutInflater().inflate(R.layout.workspace_screen, this, false);
    ...
    protected void overScroll(float amount) {
        boolean shouldOverScroll =
                (amount <= 0 && (!hasCustomContent() || mIsRtl)) || (amount >= 0 && (!hasCustomContent() || !mIsRtl));

        boolean shouldScrollOverlay = mLauncherOverlay != null && ((amount <= 0 && !mIsRtl) || (amount >= 0 && mIsRtl));

        boolean shouldZeroOverlay =
                mLauncherOverlay != null && mLastOverlaySroll != 0
    ...
    public Animator setStateWithAnimation(State toState, int toPage, boolean animated, HashMap<View, Integer> layerViews) {
        ...
        Animator workspaceAnim =
                mStateTransitionAnimation.getAnimationToState(mState, toState, toPage, animated, layerViews);
    ...
    public void getPageAreaRelativeToDragLayer(Rect outArea) {
        ...
        outArea.set(mTempXY[0], mTempXY[1], (int) (mTempXY[0] + scale * boundingLayout.getMeasuredWidth()),
    ...
    static Rect getCellLayoutMetrics(Launcher launcher, int orientation) {
        ...
        if (orientation == CellLayout.LANDSCAPE) {
            if (mLandscapeCellLayoutMetrics == null) {
                ...
                mLandscapeCellLayoutMetrics.set(DeviceProfile.calculateCellWidth(width, countX),
            ...
            if (mPortraitCellLayoutMetrics == null) {
                ...
                mPortraitCellLayoutMetrics.set(DeviceProfile.calculateCellWidth(width, countX),
                        DeviceProfile.calculateCellHeight(height, countY), 0, 0);
            }
